"""
Ejemplo 16: Imagen de fondo
Este ejemplo introduce elementos visuales mejorados al juego:

1. Imagen de fondo:
   - Carga y visualización de una imagen de fondo
   - Integración con los elementos existentes
   - Mejora visual del juego

2. Gestión de recursos:
   - Carga segura de imágenes
   - Organización en carpeta de recursos
...
# Cargamos los recursos multimedia
# Efectos de sonido
try:
    sonido_raqueta = pygame.mixer.Sound('recursos/Ping_Pong.wav')
    sonido_aplausos = pygame.mixer.Sound('recursos/Aplausos.wav')
except pygame.error as e:
    print(f"Error al cargar los efectos de sonido: {e}")
    print("El juego continuará sin sonidos")
    sonido_raqueta = None
...
try:
    ...
    print("El juego continuará con fondo negro")
    imagen_fondo = None
...
pygame.display.set_caption("Ejemplo 16: Imagen de fondo")
...
def reproducir_sonido(sonido):
    ...
    Args:
        sonido: Objeto Sound de pygame a reproducir
    """
...
def actualizar_puntuacion(marcador_actual, punto_para_jugador1):
    ...
    # Reproducimos el sonido de aplausos al marcar
    reproducir_sonido(sonido_aplausos)
...
while True:
    ...
    if (posicion_pelota.x - TAMANO_PELOTA < raqueta1.x + raqueta1.ancho and
        ...
        reproducir_sonido(sonido_raqueta)
