# -*- coding: utf-8 -*-
"""
Ejemplo 13: Visualización del marcador en pantalla
Este ejemplo introduce la visualización gráfica del marcador:

1. Interfaz gráfica:
   - Marcador visible en la pantalla de juego
   - Uso de fuentes para mostrar números
   - Posicionamiento estratégico de los marcadores
...
3. Posicionamiento:
   - Marcador del jugador 1 en el cuarto izquierdo
   - Marcador del jugador 2 en el cuarto derecho
   - Altura ajustada para no interferir con el juego
"""
...
TAMANO_FUENTE = 96
ALTURA_MARCADOR = ALTO_VENTANA // 8  # Posición vertical de los marcadores
...
pygame.display.set_caption("Ejemplo 13: Marcadores en pantalla")

# Configuración de la fuente para los marcadores
fuente_marcador = pygame.font.SysFont('arial', TAMANO_FUENTE)
...
def actualizar_puntuacion(marcador_actual, punto_para_jugador1):
    ...
    Args:
        ...
        punto_para_jugador1: True si el punto es para el jugador 1, False si es para el jugador 2
    ...
    # Mostramos el marcador actual en la consola
...
def dibujar_marcadores(pantalla, marcador, fuente):
    ...
    """
    # Renderizamos los números como texto
    ...
    # Calculamos las posiciones (centrado en cuartos de pantalla)
    pos_x1 = ANCHO_VENTANA // 4
    pos_x2 = (ANCHO_VENTANA * 3) // 4
    
    # Obtenemos los rectángulos de los textos para centrarlos
...
while True:
    ...
    if posicion_pelota.x <= TAMANO_PELOTA:  # Punto para el jugador 2
        marcador = actualizar_puntuacion(marcador, False)  # Actualizar marcador
    ...
    if posicion_pelota.x >= ANCHO_VENTANA - TAMANO_PELOTA:  # Punto para el jugador 1
        marcador = actualizar_puntuacion(marcador, True)  # Actualizar marcador
