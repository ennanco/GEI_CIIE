# -*- coding: utf-8 -*-
"""
Ejemplo 12: Sistema de puntuación
Este ejemplo introduce el sistema de puntuación:
...
2. Lógica de puntuación:
   - Punto cuando la pelota sale por los laterales
   - Jugador 1 puntúa cuando sale por la derecha
   - Jugador 2 puntúa cuando sale por la izquierda

3. Feedback al jugador:
   - Mensaje en consola con el marcador actual
   - Pausa para ver el resultado
   - Reinicio desde el centro hacia el perdedor
"""
...
pygame.display.set_caption("Ejemplo 12: Sistema de puntuación")
