"""
Ejemplo 15: Efectos de sonido en el juego
Este ejemplo introduce retroalimentación sonora al juego:

1. Efectos de sonido:
   - Sonido de rebote al golpear las raquetas
   - Aplausos cuando se marca un punto
   - Gestión de recursos de audio

2. Retroalimentación al jugador:
   - Feedback inmediato en las colisiones
   - Celebración de puntos con sonido
...
pygame.init()
pygame.mixer.init()  # Inicializamos el sistema de sonido
...
try:
    ...
    print("El juego continuará sin efectos de sonido")
    sonido_raqueta = None
...
pygame.display.set_caption("Ejemplo 15: Sonidos")
